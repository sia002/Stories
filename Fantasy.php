...
$sql = "SELECT * FROM fantasy_books $orderBy LIMIT $limit OFFSET $offset";
$result = $db->sql($sql);
?>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 text-center">
            <h1 class="my-5 text-dark">Fantasy</h1>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 text-center">
            <h3 class="my-5 text-info">Populære fantasybøger</h3>
        </div>
    </div>
</div>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
    <div class="carousel-inner">
        <?php
        $sql = "SELECT * FROM fantasy_books ORDER BY rating DESC LIMIT 8";
        $result = $db->sql($sql);
        ...
        if (empty($result)) {
            ...
            foreach ($result as $row) {
                echo '<a href="review_fantasy.php?id=' . htmlspecialchars($row->id) . '" class="card-link">
...
<div class="container">
    <div class="row">
        <div class="col text-center">
            <h3 class="my-5 text-info">Mere fantasy</h3>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row justify-content-center" >
       ...
       $sql = "SELECT * FROM fantasy_books $orderBy LIMIT $limit OFFSET $offset";
        ...
        echo '<div class="col-4 col-md-3 col-lg-3 mb-4">
            <a href="review_fantasy.php?id=' . htmlspecialchars($row->id) . '" class="card-link" style="text-decoration: none; color: inh">
