...
$sql = "SELECT * FROM e_bio_books $orderBy LIMIT $limit OFFSET $offset";
$result = $db->sql($sql);
?>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="4000">
    <div class="carousel-inner">
        <?php
        $sql = "SELECT * FROM e_bio_books ORDER BY rating DESC LIMIT 8";
        $result = $db->sql($sql);
        ...
        if (empty($result)) {
            ...
            foreach ($result as $row) {
                echo '<a href="review_e_bio.php?id=' . htmlspecialchars($row->id) . '" class="card-link">
...
<div class="container mb-4">
    <div class="row justify-content-center" >
        ...
        if (empty($result)) {
            ...
            <a href="review_e_bio.php?id=' . htmlspecialchars($row->id) . '" class="card-link" style="text-decoration: none; color: inherit;">
