...
$sql = "SELECT * FROM krimi_books $orderBy LIMIT $limit OFFSET $offset";
$result = $db->sql($sql);
?>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 text-center">
            <h1 class="my-5 text-dark">Krimi</h1>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col text-center">
            <h3 class="my-5 text-info">Mere krimi</h3>
        </div>
    </div>
    <div class="row">
...
<div class="container mb-4">
    <div class="row justify-content-center" >
        ...
        if (empty($result)) {
            ...
            <a href="review_krimi.php?id=' . htmlspecialchars($row->id) . '" class="card-link" style="text-decoration: none; color: inherit;">
