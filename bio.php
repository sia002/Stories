...
$sql = "SELECT * FROM bio_books $orderBy LIMIT $limit OFFSET $offset";
$result = $db->sql($sql);
?>
...
<div class="container">
    <div class="row">
        <div class="col text-center">
            <h3 class="my-5 text-info">Flere biografier</h3>
        </div>
    </div>
    <div class="row">
...
<div class="container mb-4">
    <div class="row justify-content-center" >
        ...
        if (empty($result)) {
            ...
            <a href="review_bio.php?id=' . htmlspecialchars($row->id) . '" class="card-link" style="text-decoration: none; color: inherit;">
